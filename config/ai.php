    ...
    */
    ...
    'providers' => [
        ...
        'qwen' => [
            ...
            'models' => [
                'text' => [
                    'default' => env('QWEN_MODEL', 'qwen3.7-plus'),
                    'cheapest' => env('QWEN_MODEL_CHEAPEST', env('QWEN_MODEL', 'qwen3.7-plus')),
                    'smartest' => env('QWEN_MODEL_SMARTEST', env('QWEN_MODEL', 'qwen3.7-plus')),
                ],
            ],
        ],
